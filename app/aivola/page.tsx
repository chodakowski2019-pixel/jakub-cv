...
const whyMe = [
  ...
  {
    icon: "🧭",
    title: "Umiejętność komunikacji i przekazywania wiedzy",
    desc: "Przez wiele lat zajmowałem się sprzedażą i marketingiem, dzięki czemu nabyłem solidne kompetencje w obszarze kontaktu i komunikacji z ludźmi. Potrafię przekazywać wiedzę w sposób przystępny — zadaję pytania, naprowadzam na rozwiązania, dostosowuję język do odbiorcy.",
  },
  {
    icon: "🔥",
    title: "Pasja od pierwszego dnia",
    desc: "30 listopada 2022 roku — premiera ChatGPT. Od tego dnia każdy mój projekt zawodowy opiera się o AI. To nie jest dla mnie temat zainteresowań, lecz centralny obszar mojej działalności zawodowej.",
  },
];
...
const howILead = [
  {
    ...
    desc: "Wprowadzę dzieci w narzędzia Midjourney, Canva oraz ChatGPT. Wspólnie napiszemy scenariusz, wygenerujemy panele i dodamy dialogi. Rezultat: ukończony komiks po pierwszych zajęciach.",
  },
  {
    title: "Muzyka z AI",
    desc: "Suno oraz Udio — od koncepcji do gotowego utworu w 10 minut. Uczniowie określają nastrój, gatunek i temat, a następnie obserwują, jak AI komponuje ich muzykę. Po wygenerowaniu utworu analizujemy proces: jak działa technologia, co można udoskonalić.",
  },
  {
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          <div className="flex justify-center mb-8">
            <img
              ...
              className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover border-2 border-emerald-500/30 shadow-2xl shadow-emerald-500/10"
            />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {whyMe.map((item, i) => (
              ...
              >
                ...
                <h3 className="font-semibold mb-2 text-neutral-100">{item.title}</h3>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="p-5 rounded-2xl border border-emerald-500/15 bg-emerald-500/[0.04]">
              <img
                ...
                className="w-full h-48 object-contain rounded-xl mb-4 bg-white/95 p-2"
              />
              ...
              <p className="text-sm text-neutral-400 leading-relaxed">
                Intensywny 7-tygodniowy program edukacyjny (ponad 35 godzin warsztatów i wykładów, projekt końcowy oraz egzamin pisemny). Prowadzenie: Maria Parysz, ekspertka wdrażająca AI w Rolls-Royce oraz Sephora.
              </p>
            </div>
            <div className="p-5 rounded-2xl border border-emerald-500/15 bg-emerald-500/[0.04]">
              <img
            ...
            {howILead.map((item, i) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <span className="text-emerald-400/60 text-sm font-mono mt-0.5 flex-shrink-0">
                    0{i + 1}
                  </span>
                  <div>
                    <h3 className="font-semibold text-sm text-neutral-100 mb-1">
                      {item.title}
                    </h3>
                    <p className="text-sm text-neutral-400 leading-relaxed">
                      {item.desc}
        ...
        <div className="max-w-3xl mx-auto">
          <div className="p-8 rounded-2xl border border-white/[0.06] bg-white/[0.02] text-center">
            ...
            <p className="text-neutral-400 leading-relaxed max-w-xl mx-auto">
              Prowadzę firmy, prowadzę zespoły, prowadzę szkolenia — wszystko zdalnie. Sprzęt, internet, otoczenie pracy — wszystko gotowe pod profesjonalne prowadzenie zajęć online.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-white/[0.015]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            <div className="p-6 rounded-2xl border border-emerald-500/15 bg-emerald-500/[0.04]">
              <h3 className="font-semibold text-neutral-100 mb-2">Praktyk, nie teoretyk</h3>
              <p className="text-sm text-neutral-400 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl border border-emerald-500/15 bg-emerald-500/[0.04]">
              <h3 className="font-semibold text-neutral-100 mb-2">Tłumacz między AI a człowiekiem</h3>
              <p className="text-sm text-neutral-400 leading-relaxed">
                Przez ostatnie trzy lata tłumaczyłem zagadnienia AI osobom, które obawiały się tej technologii — nauczycielom, właścicielom firm oraz sprzedawcom. Potrafię rozłożyć złożone koncepcje na zrozumiałe elementy. W przypadku dzieci ten proces będzie jeszcze efektywniejszy — nie posiadają one mentalnych barier wobec nowych technologii.
              </p>
            </div>
            <div className="p-6 rounded-2xl border border-emerald-500/15 bg-emerald-500/[0.04]">
              <h3 className="font-semibold text-neutral-100 mb-2">Energia twórcy</h3>
              <p className="text-sm text-neutral-400 leading-relaxed">
                Aktywnie tworzę z wykorzystaniem sztucznej inteligencji — aplikacje, treści, modele biznesowe. Ta energia twórcza jest zaraźliwa. Uczniowie nie wyjdą z zajęć wyłącznie z wiedzą teoretyczną o AI, lecz z motywacją do tworzenia własnych rozwiązań. To zasadnicza różnica.
              </p>
            </div>
          </div>
        </div>
